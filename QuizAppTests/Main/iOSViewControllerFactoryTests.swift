...
class iOSViewControllerFactoryTests: XCTestCase {
    ...
    func makeResults() -> (controller: ResultsViewController, presenter: ResultsPresenter) {
        ...
        let result = GameResult.make(answers: userAnswers, score: 2)
...
private extension ResultsPresenter {
    convenience init(result: GameResult<Question<String>, [String]>, questions: [Question<String>], correctAnswers: [Question<String>: [String]]) {
