...
class ResultsPresenterTests: XCTestCase {
    ...
    func test_summary_withTwoQuestionAndScoresOne_returnsSummary() {
        let answers = [singleAnswerQuestion: ["A1"], multipleAnswerQuestion: ["A2", "A3"]]
        let orderedQuestions = [singleAnswerQuestion, multipleAnswerQuestion]
        let result = GameResult.make(answers: answers, score: 1)
    ...
    func test_presentableAnswers_withTwoQuestions_mapsOrdererdAnswers() {
